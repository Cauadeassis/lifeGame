...
import {
  PlayerMessage,
  ParentMessage,
} from "./components/ui/descriptionContainer/messages.tsx";
import {
  LoadingFallback,
  NoCharacterFallback,
} from "./components/ui/fallback/fallback.tsx";
import ActionButton from "./components/ui/actionButton/actionButton.tsx";
import AdvanceYearButton from "./components/ui/advanceYearButton/advanceYearButton.tsx";
import StatBar from "./components/ui/statBar/statBar.tsx";
...
import {
  ...
  GameState,
  GameData,
} from "../../services/gameStorage.ts";
import { advanceYear, applyStatsChange } from "../../services/gameLogic.ts";

import { Character, Stats } from "../../backend/data/character/types.ts";
import { Event, Option, Result } from "../../backend/data/events/types.ts";
